...
PACKAGE ?= helm-kubescape
XRD_DIR := apis/kubescapes
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/kubescapes/standard.yaml
...
EXAMPLES := \
    examples/kubescapes/minimal.yaml:: \
    examples/kubescapes/standard.yaml::
...
render\:%:
	@example="examples/kubescapes/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
